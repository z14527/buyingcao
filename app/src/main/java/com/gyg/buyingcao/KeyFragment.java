        ...
        btnKeyEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_TEXT, uri);  //传输图片或者文件 采用流的方式
                    intent.setType("*/*");   //分享文件
                    startActivity(Intent.createChooser(intent, "编辑方式选择"));
                }catch (Exception e) {
        ...
        btnKeyExpand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!writeTxtToFile(strCaseNum,patentPath,"k"+strCaseNum + ".2.txt"))
                    return;
                Toast.makeText(getActivity(),"写文件成功：\nt" + strCaseNum + ".2.txt", Toast.LENGTH_SHORT).show();
                try {
...
//                    intent.setType("text/plain");   //分享文件
